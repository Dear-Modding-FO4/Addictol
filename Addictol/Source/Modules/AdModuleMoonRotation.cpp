...
namespace Addictol
{
	namespace Moon
	{
		...
		public:
			LunarRotationCalculator() = default;
		...
		public:
			...
			void Update(RE::Moon* a_moon, RE::Sky* a_sky) noexcept
			{
				...
				// Note: z-axis rotates the moon around the center.
				root->local.translate.x = x;
				root->local.translate.y = radius + delta_size;
